...
class Jeu:
    ...
    def update(self):
        ...
        if pyxel.btnp(pyxel.KEY_UP):
            ...
            self.toggle_pause()
        elif (pyxel.btnp(pyxel.KEY_O) or pyxel.btnp(pyxel.KEY_Y)) and config['etat'] == ETAT_FIN:
            # redémarrage du jeu
            self.restart()
        elif pyxel.btnp(pyxel.KEY_Q) or ((pyxel.btnp(pyxel.KEY_RETURN) or pyxel.btnp(pyxel.KEY_N)) and config['etat'] == ETAT_FIN):
            # fin du jeu
            pyxel.quit()
    ...
    def display_gameover(self):
        ...
        pyxel.text(45, 150, "Recommencer ? O / N", 8)
